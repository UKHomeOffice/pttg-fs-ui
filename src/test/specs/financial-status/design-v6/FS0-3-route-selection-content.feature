 ...
 ###################################### Section - Check for text on route selection page ######################################
    ...
    Scenario: Input Page checks for student type selection
        ...
        Then the service displays the following page content
            ...
            | Student type-0 | General student                                                                                        |
            | Student type-1 | Doctorate extension scheme                                                                             |
            | Student type-2 | Postgraduate doctor or dentist                                                                         |
            | Student type-3 | Student union sabbatical officer                                                                       |
