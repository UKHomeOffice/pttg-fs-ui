...
############################# pass for tier 5 (youth mobility scheme) main applicant #############################################
 ...
 ############################# Not pass as Tier 5 youth mobility scheme main applicant ###########################################

    Scenario: Warne is a Tier 5 youth mobility scheme worker #
        Given caseworker is on page t5/application/calc/main #
        And the api threshold response will be t5 #
        When the financial status check is performed with #
