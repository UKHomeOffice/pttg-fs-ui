...
fsModule.factory('FsInfoService', [ function () {
  ...
  me.text = {
    ...
    checkingNow: 'Checking consent now.',
    checkingBalance: 'Checking balances now.',
    ...
    notEnoughRecords: 'The records for this account do not cover the whole {{ nDaysRequired }} day period',
